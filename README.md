...
| `bool_true` | `true` | `true` | `[`<br>`'particle_type' => 11,`<br>`'data' => Aerospike\Blob('b:1;')`<br>`]` |
| `bool_false` | `false` | `false` | `[`<br>`'particle_type' => 11,`<br>`'data' => Aerospike\Blob('b:0;')`<br>`]` |
| `list_with_bool` | `[`<br>`1,`<br>`'two',`<br>`true,`<br>`false`<br>`]` | `[`<br>`1,`<br>`'two',`<br>`true,`<br>`false`<br>`]` | `[`<br>`1,`<br>`'two',`<br>`[`<br>`'particle_type' => 11,`<br>`'data' => Aerospike\Blob('b:1;')`<br>`],`<br>`[`<br>`'particle_type' => 11,`<br>`'data' => Aerospike\Blob('b:0;')`<br>`]`<br>`]` |
| `list_with_null` | `[`<br>`1,`<br>`'two',`<br>`null`<br>`]` | `[`<br>`1,`<br>`'two',`<br>`null`<br>`]` | `[`<br>`1,`<br>`'two',`<br>`[`<br>`'particle_type' => 11,`<br>`'data' => Aerospike\Blob('N;')`<br>`]`<br>`]` |
| `map_with_bool` | `[`<br>`'a' => 1,`<br>`'b' => 'two',`<br>`'c' => true,`<br>`'d' => false`<br>`]` | `[`<br>`'a' => 1,`<br>`'b' => 'two',`<br>`'c' => true,`<br>`'d' => false`<br>`]` | `[`<br>`'a' => 1,`<br>`'b' => 'two',`<br>`'c' => [`<br>`'particle_type' => 11,`<br>`'data' => Aerospike\Blob('b:1;')`<br>`],`<br>`'d' => [`<br>`'particle_type' => 11,`<br>`'data' => Aerospike\Blob('b:0;')`<br>`]`<br>`]` |
| `map_with_null` | `[`<br>`'a' => 1,`<br>`'b' => 'two',`<br>`'c' => null`<br>`]` | `[`<br>`'a' => 1,`<br>`'b' => 'two',`<br>`'c' => null`<br>`]` | `[`<br>`'a' => 1,`<br>`'b' => 'two',`<br>`'c' => [`<br>`'particle_type' => 11,`<br>`'data' => Aerospike\Blob('N;')`<br>`]`<br>`]` |
| `php_object` | `DemoObject(label: 'a plain PHP object', count: 3)` | `Aerospike\BLOB('O:10:"DemoObject":2:{s:5:"label";s:18:"a plain PHP object";s:5:"count";i:3;}')` | `[`<br>`'particle_type' => 11,`<br>`'data' => Aerospike\Blob('O:10:"DemoObject":2:{s:5:"label";s:18:"a plain PHP object";s:5:"count";i:3;}')`<br>`]` |
| `list_with_object` | `[`<br>`DemoObject(label: 'nested', count: 7)`<br>`]` | `[`<br>`Aerospike\BLOB('O:10:"DemoObject":2:{s:5:"label";s:6:"nested";s:5:"count";i:7;}')`<br>`]` | `[`<br>`[`<br>`'particle_type' => 11,`<br>`'data' => Aerospike\Blob('O:10:"DemoObject":2:{s:5:"label";s:6:"nested";s:5:"count";i:7;}')`<br>`]`<br>`]` |
| `map_with_object` | `[`<br>`'a' => DemoObject(label: 'nested', count: 7)`<br>`]` | `[`<br>`'a' => Aerospike\BLOB('O:10:"DemoObject":2:{s:5:"label";s:6:"nested";s:5:"count";i:7;}')`<br>`]` | `[`<br>`'a' => [`<br>`'particle_type' => 11,`<br>`'data' => Aerospike\Blob('O:10:"DemoObject":2:{s:5:"label";s:6:"nested";s:5:"count";i:7;}')`<br>`]`<br>`]` |
